...
class Server {
  constructor() {
    ...
    this.catInsumoPath = "/catInsumo"; //Ruta de la API
    this.tipoEstampadoPath = "/tipoEstampado";
    this.middlewares();
    this.routes();
    this.conectarDB();
  }
  ...
  routes() {
    this.app.use(this.catInsumoPath, require("../routes/catInsumo"));
    this.app.use(this.tipoEstampadoPath, require("../routes/tipoEstampado"));
  }
